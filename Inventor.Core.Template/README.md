...
This is a Template for writting dotnet core based Inventor Addins. Version 2025 and higher. The complete documentation can be found here: [ExtrabbitCode Inventor Core Template Documentation](https://github.com/TWiesendanger/ExtrabbitCode.InventorTemplate)
